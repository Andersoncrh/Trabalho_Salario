...
{
    public class EmpregadoComissionado : Empregado, ICalcula_Salario_Bruto, ICalcula_Salario_Familia, ICalcula_Salario_Liquido, ICalcula_INSS
    {
        //ATRIBUTOS DA CLASSE
            public double ValorVendido, TaxadeComissao;
        //##############################
        //METODO HERDADO PELA INTERFACE
            public double CalculaSalarioBruto()
            {
                return ValorVendido * (TaxadeComissao * 0.01);
            }
        //###################
        //METODO HERDADO PELA INTERFACE
